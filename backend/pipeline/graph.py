...
def run_pipeline(
    ...
    Args:
        ...
        source: Trigger provenance — "upload" | "sample" | "email"
        sender_email: SU sender address, when triggered by an inbox email
        subject: Email subject line, when triggered by an inbox email
        received_at: ISO timestamp the email was received, when applicable
